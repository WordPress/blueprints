...
Welcome to this comprehensive guide to Blueprints, where you'll find everything you need to know: what they are, how to create them, and how to use them effectively.
...
> The team is exploring ways to transition Blueprints from their current TypeScript implementation to a PHP-based library. This would enable Blueprints to run in any WordPress environment, including Playground, a hosted site, or a local setup.
>
